...
// NewAudioDeviceOption returns an Option instance that can be used to specify
// audio devices.
func NewAudioDeviceOption(name string, id string, properties ...*AudioDevProperty) *queso.Option {
...
func AudioDriver(name string, id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption(name, id, properties...)
}
...
func AudioNone(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("none", id, properties...)
}
...
func AudioALSA(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("alsa", id, properties...)
}
...
func AudioCoreAudio(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("coreaudio", id, properties...)
}
...
func AudioDirectSound(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("dsound", id, properties...)
}
...
func AudioOSS(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("oss", id, properties...)
}
...
func AudioPulseAudio(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("pa", id, properties...)
}
...
func AudioSDL(id string, properties ...*AudioDevProperty) *queso.Option {
	return NewAudioDeviceOption("sdl", id, properties...)
}
...
func AudioSPICE(id string) *queso.Option {
	return NewAudioDeviceOption("spice", id)
}
...
func AudioWAV(id string, path string) *queso.Option {
	return NewAudioDeviceOption("wav", id, NewAudioDeviceProperty("path", path))
}
...
// NewAudioDeviceProperty returns a new instance of an AudioDevProperty.
func NewAudioDeviceProperty(key string, value interface{}) *AudioDevProperty {
	return &AudioDevProperty{
		Property: queso.NewProperty(key, value),
	}
}

func newAudioDeviceDirectionProperty(direction Direction, key string, value interface{}) *AudioDevProperty {
	return NewAudioDeviceProperty(fmt.Sprintf("%s.%s", direction, key), value)
}
...
func WithTimerPeriod(microseconds int) *AudioDevProperty {
	return NewAudioDeviceProperty("timer-period", microseconds)
}
...
func IsMixingEngine(direction Direction, enabled bool) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "mixing-engine", enabled)
}
...
func IsFixedSettings(direction Direction, enabled bool) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "fixed-settings", enabled)
}
...
func WithFrequency(direction Direction, frequency string) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "frequency", frequency)
}
...
func WithChannels(direction Direction, count int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "channels", count)
}
...
func WithSampleFormat(direction Direction, format SampleFormat) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "format", format)
}
...
func WithVoices(direction Direction, count int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "voices", count)
}
...
func WithAudioBufferLength(direction Direction, microseconds int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "buffer-length", microseconds)
}
...
func WithALSADevice(direction Direction, device string) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "dev", device)
}
...
func WithPeriodLength(direction Direction, microseconds int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "period-length", microseconds)
}
...
func IsTryPoll(direction Direction, enabled bool) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "try-poll", enabled)
}
...
func WithThreshold(direction Direction, microseconds int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "threshold", microseconds)
}
...
func IsTryMMAP(enabled bool) *AudioDevProperty {
	return NewAudioDeviceProperty("try-mmap", enabled)
}
...
func IsExclusive(enabled bool) *AudioDevProperty {
	return NewAudioDeviceProperty("exclusive", enabled)
}
...
func WithPulseAudioLatency(direction Direction, microseconds int) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "latency", microseconds)
}
...
func WithPulseAudioSink(direction Direction, name string) *AudioDevProperty {
	return newAudioDeviceDirectionProperty(direction, "name", name)
}
